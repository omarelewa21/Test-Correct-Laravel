...
class CreathlonItemBankSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $section = \tcCore\Section::create([
            'name' => 'Creathlon item bank sectie',
            'demo' => false,
        ]);
        ...
        $class = \tcCore\SchoolClass::create([
            'school_location_id' => $locationA->getKey(),
            'school_year_id' => $schoolYear->getKey(),
            'name' => 'Creathlon item bank schoolclass',
        ...
        $classB = \tcCore\SchoolClass::create([
            'school_location_id' => $locationA->getKey(),
            'school_year_id' => $schoolYear->getKey(),
            'name' => 'Creathlon item bank schoolclass B',
            'education_level_id' => 1,
            'education_level_year' => 1,
            'is_main_school_class' => 0,
            'do_not_overwrite_from_interface' => 0,
        ...
        $teacherB = $userFactory->generate([
            ...
            'abbreviation'       => 'TC',
            'school_location_id' => $locationA->getKey(),
            'username'           => 'info+creathlonontwikkelaar2@test-correct.nl',
            'password'           => 'Sobit4456',
            'user_roles'         => [1],
            'gender'             => 'Male',
        ]);
        ...
        BaseSubject::all()->each(function($baseSubject) use($teacherA,$teacherB,$class,$classB,$section,$periodLocationA) {
            ...
            $test = new Test([
                ...
                'test_kind_id'=>3,
                'name'=>'test toets Creathlon item bank '.$subject->name,
                'abbreviation'=>'',
                'education_level_year'=>1,
                'status'=>1,
                'introduction'=>'Beste docent,

                                   Dit is de test toets voor de Creathlon item bank.',
                'shuffle'=>false,
                'is_system_test'=>false,
                'question_count'=>0,
                'is_open_source_content'=>false,
                'demo'=>false,
                'scope'=>'not_publs', //not finished: not_ldt, if finished: ldt
                'published'=>'1',
            ]);
