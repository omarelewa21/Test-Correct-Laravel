...
class haxe_Int64
{
    ...
    public static function ofInt32($x)
    {
    ...
    public static function divMod($modulus, $divisor)
    {
        ...
        return _hx_anonymous(['quotient' => $quotient, 'modulus' => $modulus]);
    }
    ...
    public static function toStr($a)
    {
        return $a->toString();
    }
