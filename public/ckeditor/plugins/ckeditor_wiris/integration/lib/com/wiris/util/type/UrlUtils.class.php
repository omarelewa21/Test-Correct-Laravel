...
class com_wiris_util_type_UrlUtils
{
    ...
    public static $charCodeA;

    public static $charCodeZ;

    public static $charCodea;

    public static $charCodez;

    public static $charCode0;

    public static $charCode9;

    public static function isAllowed($c)
    {
    ...
    public static function urlComponentEncode($uriComponent)
    {
        $sb = new StringBuf();
    ...
    {
        return 'com.wiris.util.type.UrlUtils';
    }
}
