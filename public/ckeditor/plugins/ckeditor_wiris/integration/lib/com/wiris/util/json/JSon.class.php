...
class com_wiris_util_json_JSon
{
    ...
    public static function getDepth($o)
    {
        if (com_wiris_system_TypeTools::isHash($o)) {
            $h = $o;
            $m = 0;
    ...
    public static function getString($o)
    {
        return $o;
    }

    public static function getFloat($n)
    {
    ...
    public static function getInt($n)
    {
        if (Std::is($n, _hx_qtype('Float'))) {
            return Math::round($n);
        } else {
    ...
    public static function getArray($a)
    {
        return $a;
    }

    public static function getHashArray($a)
    {
        return $a;
    }

    public static function getHash($a)
    {
        return $a;
    }
    ...
    {
        return 'com.wiris.util.json.JSon';
    }
}
