...
class com_wiris_util_sys_IniFile
{
    ...
    public static function newIniFileFromFilename($path)
    {
    ...
    public static function newIniFileFromString($inifile)
    {
        $ini = new com_wiris_util_sys_IniFile();
        $ini->filename = '';
    ...
    public static function propertiesToString($h)
    {
        $sb = new StringBuf();
        $iter = $h->keys();
        $keys = new _hx_array([]);
    ...
    {
        return 'com.wiris.util.sys.IniFile';
    }
}
