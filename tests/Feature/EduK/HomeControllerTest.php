...
//    use DatabaseTransactions;
    ...
    protected function setUp(): void
    {
        ...
        $this->schoolLocationForService = SchoolLocation::where('customer_code', 'standaard testschool')->first();
     ...
     */
    private function getTestResponse(array $attributes): \Illuminate\Foundation\Testing\TestResponse
    {
        return $this->post(
            sprintf(
                'edu-ix/%s/%s/%s',
