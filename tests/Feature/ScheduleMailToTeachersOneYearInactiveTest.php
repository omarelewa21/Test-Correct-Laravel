...
class ScheduleMailToTeachersOneYearInactiveTest extends TestCase
{
    ...
    public function test_teacher_created_seven_months_ago_last_login_seven_months_ago_active_school_true()
    {
        ...
        $loginLog->user_id =$user->getKey();
        $loginLog->created_at = $this->createdAt7MonthsAgo;
        $loginLog->save();

        $this->assertNotContains($user->username,(new ScheduleMailToTeachersOneYearInactive())->getListOfInactiveTeachers());
    }
    ...
    public function test_teacher_created_thirteen_months_ago_last_login_thirteen_months_ago_active_school_true()
    {
        ...
        dd([$user->username,(new ScheduleMailToTeachersOneYearInactive())->getListOfInactiveTeachers()]);
        $this->assertContains($user->username,(new ScheduleMailToTeachersOneYearInactive())->getListOfInactiveTeachers());
    }
