...
class FactoryQuestionTest extends TestCase
{
    ...
    public function can_add_a_random_question_to_a_test()
    {
        ...
        $testFactory = FactoryTest::create($this->user)->addRandomQuestions(); //default === (int) 1
    ...
    public function can_add_a_multitude_of_random_questions_to_a_test()
    {
        ...
        $testFactory = FactoryTest::create($this->user)->addRandomQuestions($amountOfQuestions);
    ...
    public function can_add_all_question_to_a_test()
    {
        ...
        $testFactory = FactoryTest::create($this->user)->addAllQuestions();
