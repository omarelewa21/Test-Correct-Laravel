...
return [
    ...
    'Halve puntenbeoordeling mogelijk'                                                                     => 'Allow half points scoring',
    ...
    'Hoofdlettergevoelig nakijken'                                                                         => 'Case-sensitive assessment',
    'Taxonomie'                                                                                            => 'Taxonomy',
    'methode'                                                                                              => 'method',
    ...
    'carousel_subquestions_scores_differ_relation'                                                         => 'The relation question has a number of points that is not equal to the other questions in this question group. This is necessary because the question group is set up for \'carousel.\' Ensure that the questions in this question group all have the same number of points by adjusting the points and/or the question.',
    'carousel_subquestions_scores_differ_relation_title'                                                   => 'Questions in this question group do not all have the same number of points.',
    ...
    'half_point_validation_text'                                                                           => 'You cannot assign a half point value to an answer option when \'Allow half points scoring\' is disabled.',
    ...
    'Aantal woorden als carrousel'                                                                         => 'Amount of words as carrousel',
    ...
    'Hoe wil je een woordenlijst toevoegen'                                                                => 'How would you like to add a wordlist',
    'Nieuwe woordenlijst'                                                                                  => 'New wordlist',
    'Bestaande woordenlijst'                                                                               => 'Existing wordlist',
    'Upload bestand'                                                                                       => 'Upload file',
    'add_list_modal_new_list_description'                                                                  => 'Make a new wordlist (f.e. per chapter)',
    'add_list_modal_existing_list_description'                                                             => 'Choose an existing wordlist from the wordlist bank',
    'add_list_modal_upload_list_description'                                                               => 'Make a new wordlist from an Excel or CSV file',
    'Woordenlijstenbank'                                                                                   => 'Word list bank',
    'Woordenbank'                                                                                          => 'Word bank',
    'Toevoegen aan woordenlijst'                                                                           => 'Add to word list',
    'Woordenlijst toevoegen'                                                                               => 'Add word list',
    'Importeer uit Excel'                                                                                  => 'Import from Excel',
    'excel_import_modal_explainer'                                                                         => 'The file has to meet certain criteria, so we can convert your file as good as possible',
    'Voorwaarden'                                                                                          => 'Criteria',
    'Bestand met 1 tabblad'                                                                                => 'File has 1 tab',
    'Max. 6 kolommen'                                                                                      => 'Max. :columns columns',
    'Geen kolomkoppen'                                                                                     => 'No column heads',
    'Min. taalvak taal kolom met'                                                                          => 'Min. subject language column',
    'Min. vertaaltaal kolom'                                                                               => 'Min. translation column',
    'Indien toevoeging bestaande lijst'                                                                    => 'When addition to an existing list',
    'Volgorde kolommen hetzelfde als bestaande lijst'                                                      => 'Order of columns match the existing list',
    'Ik begrijp het'                                                                                       => 'I understand',
    'Verschillend per student'                                                                             => 'Different for each student',
    'Afname instellingen'                                                                                  => 'Test take settings',
    'relation-question-intro'                                                                              => 'Select the questions students see . You can can set this per category (column), as well as per word (cell) by clicking on it. The student answers in the subject language by default. When the subject language is selected, the student answers with the Dutch translation.',
    'Vak'                                                                                                  => 'Subject',
    'Vertaling'                                                                                            => 'Translation',
    'Definitie'                                                                                            => 'Definition',
    'Synoniem'                                                                                             => 'Synonym',
    'Woord'                                                                                                => 'Word',
    'validation_required_type_amount'                                                                      => 'There are at least 2 categories with words required.',
    'validation_duplicate_columns'                                                                         => 'There are duplicate categories selected.',
    'validation_words_without_type'                                                                        => 'There is no category selected for column %column%.',
    'validation_words_without_type_multi'                                                                  => 'There are no categories selected for the columns %column%.',
    'validation_column_without_words'                                                                      => 'The category %type% has no words.',
    'validation_column_without_words_multi'                                                                => 'The categories %type% have no words.',
    'validation_required_subject_word'                                                                     => 'Row %row% has no subject word.',
    'validation_required_subject_word_multi'                                                               => 'Rows %row% have no subject word',
    'validation_required_words_per_row'                                                                    => 'Row %row% does not have enough words.',
    'validation_required_words_per_row_multi'                                                              => 'Rows %row% do not have enough words.',
    'Hoe wil je toevoegen'                                                                                 => 'How do you want to add',
    'word-list-choose-how-to-add-start'                                                                    => 'Do you want to add the list',
    'word-list-choose-how-to-add-mid'                                                                      => 'to your current list ‘:current’',
    'word-list-choose-how-to-add-end'                                                                      => 'Or do you want to add this list separately?',
    'Apart toevoegen'                                                                                      => 'Add separately',
    'Aan huidige toevoegen'                                                                                => 'Add to current',
    'Bestaande woorden toevoegen'                                                                          => 'Add existing words',
    'Bekijk wijzigingen woordenlijsten'                                                                    => 'Look at changes',
    'Wijzigingen woordenlijsten'                                                                           => 'Changed word lists',
