<div class="w-full space-y-8 mt-40 page-break-before-pdf">
    ...
    @endforeach
    <h2 class="student-testtake-answers-separator"><span
                class="student-testtake-answers-label">{{__('Einde antwoorden').' '.$studentName}}</span></h2>
</div>
