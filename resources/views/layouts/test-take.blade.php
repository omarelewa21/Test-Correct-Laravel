...
>
    <div class="breadcrumbs | flex w-full border-b border-secondary sticky z-1 sticky-pseudo-bg  h-[50px] items-center">
        <div class="w-full mx-auto px-[2rem] xl:px-[90px]  z-1">
    ...
    <div class="test-info | w-full mx-auto px-[2rem] xl:px-[90px]  border-b border-secondary bg-gradient-to-t from-white to-lightGrey"
    ...
    <div class="page-content | flex flex-col w-full mx-auto px-[2rem] xl:px-[90px]  py-10 gap-8">
