<x-layouts.base>
    <header id="header"
            class="header top-0 fixed w-full h-auto py-2.5 px-6 z-20 main-shadow @if(\tcCore\Http\Helpers\GlobalStateHelper::getInstance()->hasActiveMaintenance()) maintenance-header-bg @endif">
