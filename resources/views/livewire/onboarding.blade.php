                                                ...
                                                <button type="button"
                                                    ...
                                                    <svg class="mr-3" width="46" height="46"
                                                        ...
                                                        <g fill="none" fill-rule="evenodd">
                                                            <path d="M32.21 42.91C29.06 38.242 22.09 35 14 35c-2.717 0-5.307.366-7.669 1.028"
                                                                  fill="#FFF"
                                                                  stroke-linejoin="round"/>
                                                            <path d="M25.935 25.919v5.9a2.143 2.143 0 00-.004 3.518 5.517 5.517 0 01-11.028-.225l.002.081a4.596 4.596 0 00-.002-8.131v-1.143h11.032z"
                                                            ...
                                                            <g transform="translate(10 6)">
                                                                ...
                                                                <circle class="hair" stroke-linejoin="round" cx="13.177"
                                                                        cy="7.048" r="7.048"/>
                                                                <path d="M19.919 7.967c3.983 0 4.903 9.086 4.903 12.564a9.193 9.193 0 01-18.387 0c0-1.168-1.271-2.318-.874-3.396a6.72 6.72 0 01.422-.919 5.21 5.21 0 118.877-5.457c.258-.022.515-.034.768-.034 1.6 0 2.299-2.758 4.29-2.758z"
                                                                      fill="#FFF" stroke-linejoin="round"/>
                                                                ...
                                                                <path d="M17.865 16.503a1.831 1.831 0 00-1.164-.415c-.505 0-.962.204-1.295.533M24.209 15.016l-.92.612"
                                                                      stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M13.807 23.777c.637-1.043 1.079-1.002 1.65-.91.469.076 1.062.179 1.68.092.663-.093 1.183-.29 1.568-.435.358-.135.632-.22.82-.221.873.758.765 1.124.552 1.516a2.895 2.895 0 01-.673.804 3.772 3.772 0 01-1.915.843c-.894.126-1.732.023-2.365-.234-.769-.312-1.231-.845-1.317-1.455z"
                                                                      fill="#FFF" stroke-linecap="round"
                                                                      stroke-linejoin="round"/>
                                                            </g>
                                                        ...
                                                        <g fill="none" fill-rule="evenodd">
                                                            <g transform="matrix(-1 0 0 1 39.5 7)">
                                                                <path class="hair"
                                                                      ...
                                                                      stroke-linejoin="round"/>
                                                                <path d="M29.945 32.931C26.53 31.096 22.205 30 17.5 30c-5.402 0-10.304 1.446-13.903 3.795"
                                                                      fill="#FFF" stroke-linejoin="round"/>
                                                                <path d="M21.559 23.342l-.146.141a6.025 6.025 0 00-1.77 4.274c0 1.358.447 2.61 1.203 3.62-1.018 3.417-7.774 2.82-8.216.387a4.533 4.533 0 00-3.889-7.32c.157-.258.409-.514.778-.767 2.089-1.426 6.102-1.538 12.04-.335z"
                                                                      fill="#FFF" stroke-linejoin="round"/>
                                                                <path d="M14.505 27.153a9.066 9.066 0 009.066-9.066c0-.887-1.42-1.505-1.813-2.569-.495-1.34-.068-3.122-1.05-4.044a9.034 9.034 0 00-6.203-2.453c-2.72 0-5.16-1.825-6.82.072-1.398 1.595-2.245 6.706-2.245 8.994a9.066 9.066 0 009.065 9.066z"
                                                                      fill="#FFF" stroke-linejoin="round"/>
                                                                ...
                                                                <path d="M15.261 14.611c.302-.453 2.418-1.057 3.626 0M10.124 13.856c-1.008-.604-1.965-.705-2.871-.302M11.198 18.255c.012.148-.695.522-.777.777-.13.4.13.762 1.295 1.036M10.88 22.015c1.41.705 2.517.705 3.323 0"
                                                                      stroke-linecap="round" stroke-linejoin="round"/>
                                            ...
                                            @if($this->registration->gender === 'different')
                                                <button type="button"
                                                    ...
                                                    <svg class="mr-3" width="46" height="46"
                                                         xmlns="http://www.w3.org/2000/svg">
                                                        <g fill="none" fill-rule="evenodd">
                                                            <path d="M36.94 39.82C33.338 37.456 28.42 36 23 36c-5.373 0-10.251 1.43-13.845 3.757"
                                                                  fill="#FFF" stroke-linejoin="round"/>
                                                            <path d="M23.325 30.874c1.5 0 2.837.698 3.704 1.787a2.367 2.367 0 00.847 4.24 4.734 4.734 0 01-9.186-.335 1.992 1.992 0 00.546-3.346 4.732 4.732 0 014.089-2.346z"
                                                                  fill="#FFF" stroke-linejoin="round"/>
                                                            <path d="M22.895 34.004a8.32 8.32 0 01-8.32-8.32c0-.43-.445-2.236-1.421-3.36-.977-1.125-1.115-1.296-1.035-2.604.139-2.25 1.747-3.85 3.975-5.376 2.227-1.526 4.6.245 6.801.245 2.496 0 4.736-1.674 6.26.066 1.284 1.464 2.061 8.93 2.061 11.028a8.32 8.32 0 01-8.32 8.321z"
                                                                  fill="#FFF" stroke-linejoin="round"/>
                                                            <path class="hair"
                                                            ...
                                                            <g transform="translate(18.494 18.5)">
                                                                <path d="M6.583 5.017c.126.251.358.434.642.585.476.255.868.567.868 1.064 0 .618-.563 1.119-1.258 1.119-.506 0-.942-.266-1.142-.648"
                                                                      stroke-linecap="round" stroke-linejoin="round"/>
                                                                <circle class="eye" cx="9.697" cy="3.738" r="1"/>
                                                                <circle class="eye" cx="2.567" cy="4.309" r="1"/>
                                                                <path d="M3.355 1.748c-.665-.38-1.33-.475-1.996-.285C.81 1.62.355 2.005 0 2.618M11.326 1.846a2.415 2.415 0 00-1.449-.76c-.567-.081-1.138.087-1.712.502"
                                                                      stroke-linecap="round" stroke-linejoin="round"/>
                                                                <path d="M8.575 8.008c.142.562.129 1.16.043 1.586a3.725 3.725 0 01-.773 1.602c-.35.408-.807.712-1.357.791-2.243.32-3.23-1.701-3.23-1.701s-.197-.405-.269-.992a5.5 5.5 0 00.84.287c1.532.383 3.342.04 3.987-.476.257-.206.528-.599.76-1.097z"
                                                                      fill="#FFF" stroke-linecap="round"
                                                                      stroke-linejoin="round"/>
                                                            </g>
                                                            <circle stroke-width="2" cx="23" cy="23" r="22"/>
                                ...
                                <form wire:submit.prevent="step2" action="#" method="POST">
                                    <div class="grid grid-cols-12 gap-3 flex content-start">
                                        ...
                                        <div class="col-span-6 sm:col-span-3 md:col-span-2 input-group">
                                            <input id="number" wire:model.lazy="registration.number"
                                                   class="mt-1 form-input block w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('registration.number') border-red @enderror">
                                            <label for="number"
