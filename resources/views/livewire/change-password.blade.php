<div class="flex flex-col flex-1">
    <div class="flex flex-col max-w-sm space-y-2.5 text-left">
        <x-input.group label="{{ __('auth.current_password')}}" class="flex-1">
            <x-input.text wire:model.lazy="currentPassword" autofocus></x-input.text>
        </x-input.group>
        ...
        @enderror
        <x-input.group label="{{ __('auth.current_password_repeat')}}" class="flex-1">
            <x-input.text wire:model.lazy="currentPasswordRepeat" autofocus></x-input.text>
        </x-input.group>
        ...
        <x-input.group label="{{ __('auth.new_password')}}" class="flex-1">
            <x-input.text wire:model.lazy="newPassword" autofocus></x-input.text>
        </x-input.group>
        @error('newPassword')
        <div class="validate-red text-sm">
            {{ $message }}
