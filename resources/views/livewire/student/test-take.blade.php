<div class="w-full flex flex-col mb-5" test-take-player >
    ...
    <div class="flex pb-4 space-x-4 justify-end">
        ...
        <x-button.text-button><x-icon.attachment/><span>Bijlage 2</span></x-button.text-button>
        <x-button.text-button><x-icon.attachment/><span>Bijlage 3</span></x-button.text-button>
        <x-button.secondary size="sm">Open notitiblok</x-button.secondary>
    </div>
