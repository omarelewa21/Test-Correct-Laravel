                    ...
                    @elseif($this->step === 2)
                        <div class="content-form">
                            ...
                            <div class="mb-6 relative w-full">
                                ...
                                <h1 class="md:mt-2 top-4 card-header-text">@if($this->hasValidTUser || $this->schoolLocation) @if($this->schoolLocation) {{ __("onboarding.Jouw schoollocatie") }} @else {{ __("onboarding.Jouw schoollocaties") }} @endif @else {{ __('onboarding.Kies locatie(s)') }} @endif</h1>
