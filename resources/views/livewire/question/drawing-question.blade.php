        ...
        <div x-data="{opened: @entangle('drawingModalOpened'), answered: @entangle('answer')}"
            ...
            @else
                <div wire:ignore
                     ...
                     class="fixed flex-col left-0 top-0 xl:top-10 xl:left-10 z-50 p-4 bg-white borde    r border-blue-grey rounded-10 w-full xl:w-11/12 2xl:w-4/5 overflow-auto h-full lg:h-auto"
