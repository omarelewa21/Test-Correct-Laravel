<x-partials.question-container :number="$number" :question="$question">
    ...
    >
        <div questionHtml wire:ignore>
            ...
            <div wire:ignore class="rspopup_tlc hidden rsbtn_popup_tlc_{{$question->id}}"  ><div class="rspopup_play rspopup_btn " role="button" tabindex="0" aria-label="Lees voor" data-rslang="title/arialabel:listen" data-rsevent-id="rs_340375" title="Lees voor"><span data-rslang="content:listen">Lees voor</span></div></div>
        </div>
        @push('scripts')
            <script>
