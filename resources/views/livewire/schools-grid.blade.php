<div class="mt-10 flex-1 " id="schools-grid" x-data="">
    <div class="flex flex-1 justify-between">
        <div><h1>{{ __('school.schools') }}</h1></div>
        <div class="flex-shrink-0">
            @if($administrator)
                <x-button.cta class="" wire:click="addNewSchool">{{ __('school.new-school') }}</x-button.cta>
            @endif
        </div>
                            ...
                            <x-table.cell :slim="true" :button-cell="true">
                                @if($administrator)
                                    <x-dropdown :chevron="false" style="z-index: unset !important;">
                                        ...
                                        <x-dropdown.item wire:click="deleteSchool('{{$school->uuid}}')">
                                            <div class="flex items-center space-x-2">
                                                <x-icon.remove/>
