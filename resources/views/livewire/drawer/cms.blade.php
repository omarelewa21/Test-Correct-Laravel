    ...
    <div id="sidebar-content" class="flex flex-col bg-white">
        ...
        >
            ...
            >
                ...
                <x-button.plus-circle @click.stop="showAddQuestionSlide();dispatchBackdrop()" selid="add-question-btn"
                >
            ...
            <x-sidebar.slide-container class="divide-y divide-bluegrey" x-ref="container2" @mouseenter="handleVerticalScroll($el);">
                ...
                <x-button.plus-circle class="py-4" @click="showNewQuestion($refs.container2)" selid="create-new-question-btn">
