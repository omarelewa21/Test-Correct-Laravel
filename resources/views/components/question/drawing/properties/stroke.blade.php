...
<div class="property-group" id="stroke-{{$shape}}">
    ...
    <div class="input-with-button-group">
        <button id="decr-stroke-{{$shape}}" class="Secondary" title="{{ __('drawing-modal.Vergroot randdikte') }}">
            <div>
                <x-icon.min/>
            </div>
        </button>
        ...
        <button id="incr-stroke-{{$shape}}" class="Secondary" title="{{ __('drawing-modal.Verklein randdikte') }}">
            <div>
                <x-icon.plus/>
            </div>
        </button>
