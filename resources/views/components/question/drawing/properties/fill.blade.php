...
<div class="property-group" id="fill-{{$shape}}">
    ...
    <input type="number" name="fill-opacity-{{$shape}}" id="fill-opacity-number-{{$shape}}" min="0" max="100" value="25"
           step="1" autocomplete="off" title="{{ __('drawing-modal.Doorzichtigheid opvulkleur') }}">
    <input class="drawing-toolbar-slider" x-ref="slider" type="range" name="fill-opacity-{{$shape}}" id="fill-opacity-range-{{$shape}}" style="cursor: grab"
