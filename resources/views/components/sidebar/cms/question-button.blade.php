...
<div class="question-button flex items-center cursor-pointer bold py-2 @if($subQuestion === 'false') px-6 @endif @if($question->uuid === $this->getActiveQuestionId()) primary active @endif"
...
>
    <div class="flex w-full">
        ...
        @if($question->uuid === $this->getActiveQuestionId()) text-white bg-primary border-primary @else bg-white border-sysbase text-sysbase @endif"
