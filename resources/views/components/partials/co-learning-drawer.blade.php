...
>
    ...
    <div class="flex flex-1 flex-col sticky top-[var(--header-height)]">
        <div class="flex w-full justify-center gap-2 z-1"
            ...
            <div class="flex items-center space-x-2 w-full pt-3 h-[60px] mx-6 bold">
                <x-icon.feedback-text class="w-5" />
                <span class="w-full">@lang('co-learning.feedback geven')</span>
            </div>
{{--            <button--}}
