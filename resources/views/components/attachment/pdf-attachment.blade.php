            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer">
                    ...
                    <div id="toolbarViewerRight">
                        ...
                        <button id="print" class="toolbarButton print hiddenMediumView" martin="OK" title="Print"
                    ...
                    <div id="toolbarViewerMiddle">
                        ...
                        <span id="scaleSelectContainer" class="dropdownToolbarButton">
                          <select id="scaleSelect" title="Zoom" tabindex="23" data-l10n-id="zoom">
                            {{--<option id="pageAutoOption" title="" value="auto" disabled="disabled" hidden="true" data-l10n-id="page_scale_auto">Automatic Zoom</option>--}}
                            <option id="pageActualOption" title="" value="page-actual" data-l10n-id="page_scale_actual">Actual Size</option>
                            {{--<option id="pageFitOption" title="" value="page-fit" disabled="disabled" hidden="true" data-l10n-id="page_scale_fit">Page Fit</option>--}}
                              {{--<option id="pageWidthOption" title="" value="page-width" data-l10n-id="page_scale_width">Page Width</option>--}}
                            <option id="customScaleOption" title="" value="custom" disabled="disabled"
                                    hidden="true"></option>
                            <option title="" value="0.5" data-l10n-id="page_scale_percent"
                                    data-l10n-args='{ "scale": 50 }'>50%</option>
                            <option title="" value="0.75" data-l10n-id="page_scale_percent" selected
                        ...
                        <div class="splitToolbarButtonSeparator"></div>
                        @if(!is_null(Auth::user())&&Auth::user()->text2speech)
                            <div class="Rectangle rs_clicklistenexclude rs_starter_button"
                                 onclick="ReadspeakerTlc.player.startRsPlayer();">
                                <x-icon.rs-audio />
                                <div class="Lees-voor">
                                    {{ __('test_take.speak') }}
                                </div>
                            ...
                            <div id="readspeaker_button1" wire:ignore class="rs_skip rsbtn rs_preserve hidden">
                                <a rel="nofollow" class="rsbtn_play" title="{{ __('test_take.speak') }}"
                                   href="//app-eu.readspeaker.com/cgi-bin/rsent?customerid=12749&amp;lang=nl_nl&amp;readclass=rs_readable">
