...
>
    <input placeholder="{{ $placeholder }}" style="min-width: 170px" type="text" x-ref="datepickr" class="datepicker pl-4 w-full cursor-pointer form-input {{$multiple ? 'range' : 'single'}}">
