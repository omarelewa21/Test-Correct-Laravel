<div x-data="multiDropdownSelect(@js($options), @js($containerId))"
     x-cloak
            ...
            >
                ...
                >
                    <div class="flex py-3 gap-2 items-center"
                         x-on:click.prevent.stop="parentToggle($el, option, true)"
                    >
                ...
                <div x-show="openSubs.includes(option.value)" x-collapse.duration.150ms>
                    <template x-for="child in option.children">
                        <div class="child option | flex gap-2 py-3 w-full pl-14 items-center hover:text-primary hover:bg-primary/5 active:bg-primary/10"
                             x-on:click.prevent.stop="childToggle($el, child, true)"
