...
<div class="flex flex-col flex-1 justify-content-space-evenly space-y-3 leading-5 pdf-200px pdf-ml-2 question-no-break-dropzone" id="main-{{$attributes->get('id')}}" >
    @isset($title)
