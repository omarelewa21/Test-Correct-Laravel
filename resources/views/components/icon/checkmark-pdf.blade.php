<img class="icon_checkmark_pdf" src="data:image/svg+xml;charset=utf8,{{ rawurlencode('<svg width="13px" height="16px" viewBox="0 0 13 16" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
