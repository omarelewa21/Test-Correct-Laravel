...
<button {{ $attributes->merge([
    'class' => 'flex items-center justify-center rounded-full hover:bg-primary/5 text-sysbase transition-all relative  ' . ($size === 'md' ? 'h-10 min-w-[2.5rem] w-10 -top-3 -mr-4' : 'h-[30px] w-[30px]')
    ]) }}
