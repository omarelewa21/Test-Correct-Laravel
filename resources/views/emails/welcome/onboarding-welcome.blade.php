                ...
                <table>
                    <tr class="mb-4">
                        <td class="td-img pb-4">
                            <img src="{{asset('/svg/stickers/toetsen-maken-afnemen.svg')}}" alt="">
                        </td>
                        <td class="td-text px-5">
                            <span class="text-v-top">Toetsen aanmaken en bestaande toetsen omzetten.</span>
                        </td>
                        <td class="td-img">
                            <img src="{{asset('/svg/stickers/toetsen-beoordelen-bespreken.svg')}}" alt="">
                        </td>
                        <td class="td-text px-5">
                    ...
                    <tr>
                        <td class="td-img">
                            <img src="{{asset('/svg/stickers/klassen.svg')}}" alt="">
                        </td>
                        <td class="td-text px-5">
                            <span class="text-v-top">Klassen maken en uitnodigen om een toets af te nemen</span>
                        </td>
                        <td class="td-img">
                            <img src="{{asset('/svg/stickers/toetsresultaten-analyse.svg')}}" alt="">
                        </td>
                        <td class="td-text px-5">
