...
return [
    ...
    'olympiade_school_customercode'          => env('OLYMPIADEITEMBANK_SCHOOL_CUSTOMERCODE', 'SBON1'),
    'olympiade_school_author'                => env('OLYMPIADEITEMBANK_SCHOOL_AUTHOR', 'info+olympiadeontwikkelaar1@test-correct.nl'),

    'olympiade_archive_school_customercode'  => env('OLYMPIADEARCHICEITEMBANK_SCHOOL_CUSTOMERCODE', 'SBON'),
    'olympiade_archive_school_author'        => env('OLYMPIADEARCHIVEITEMBANK_SCHOOL_AUTHOR', 'info+olympiadeontwikkelaar@test-correct.nl'),
