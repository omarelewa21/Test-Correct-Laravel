...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware(['dll', 'student'])->prefix('student')->name('student.')->group(function () {
        ...
        Route::get('/analyses/attainment/{baseAttainment}', tcCore\Http\Livewire\Student\Analyses\AnalysesAttainmentDashboard::class)->name('analyses.attainment.show');
        Route::get('/analyses/sub-attainment/{baseAttainment}', tcCore\Http\Livewire\Student\Analyses\AnalysesSubAttainmentDashboard::class)->name('analyses.subattainment.show');
        Route::get('/analyses/sub-sub-attainment/{baseAttainment}', tcCore\Http\Livewire\Student\Analyses\AnalysesSubSubAttainmentDashboard::class)->name('analyses.subsubattainment.show');
    });
