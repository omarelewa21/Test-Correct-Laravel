    ...
    private function multiHelper($question)
    {
        ...
        $question_text = preg_replace_callback(
            ...
            function ($matches) use ($tags, $isCitoQuestion) {
                ...
                return sprintf('<select wire:model="answer.%s" class="form-input text-base disabled max-w-full overflow-ellipsis overflow-hidden" disabled>%s</select>', $matches[1],
