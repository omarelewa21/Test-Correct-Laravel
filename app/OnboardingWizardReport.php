...
class OnboardingWizardReport extends Model
{
    ...
    public static function updateForUser(User $user)
    {
        ...
        self::updateOrCreate([
            ...
            'first_test_taken_date'                       => optional($user->testTakes()->where('demo', 0)->orderBy('created_at', 'desc')->first())->created_at,
            'last_test_taken_date'                        => optional($user->testTakes()->where('demo', 0)->orderBy('created_at', 'asc')->first())->created_at,
