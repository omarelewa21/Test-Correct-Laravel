...
class CountUmbrellaOrganizationTests extends Job implements SelfHandling, ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Log::debug('Umbrella Organization #'.$this->umbrellaOrganization->getKey().' -> count_tests: '.$count);
