...
class CountSchoolLocationTestsTaken extends Job implements SelfHandling, ShouldQueue
{
    ...
    public function handle()
    {
        ...
        Log::debug('Schoollocation #'.$this->schoolLocation->getKey().' -> count_tests_taken: '.$count);
