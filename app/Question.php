...
class Question extends MtiBaseModel {
     ...
     * @var array
     */
    protected $fillable = ['subject_id', 'education_level_id', 'type', 'question', 'education_level_id', 'score', 'decimal_score', 'note_type', 'rtti', 'add_to_database','is_open_source_content'];
